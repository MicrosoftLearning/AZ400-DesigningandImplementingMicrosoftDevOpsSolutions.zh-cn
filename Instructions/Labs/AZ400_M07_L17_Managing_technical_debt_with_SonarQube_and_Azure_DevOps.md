...
1. 1. 在实验室计算机上，在显示 Azure DevOps 门户的 Web 浏览器窗口中，打开 eShopOnWeb 项目，然后单击“项目设置”（左下角）。 将“可见性”更改为“公共”。 单击“保存”
...
1. Sonarcloud 还会使用注释来修饰拉取请求，说明不建议在最近采取的做法。 还可以在 Sonarcloud 中查看完整报告以了解详细信息。
