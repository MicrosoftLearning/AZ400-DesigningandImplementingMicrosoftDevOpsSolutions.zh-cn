...
1. 转到“**管道 > 管道**”。
1. 单击“新建管道”按钮（如果没有任何管道，则单击“创建管道”）。********
...
1. 单击页面右上角的“保存”按钮（而不是“保存并运行”）来保存管道定义。******** 可以通过单击“保存并运行”（或“运行”）按钮右侧的箭头来查找“保存”按钮。************
...
1. 单击“验证并保存”按钮，如果验证成功，再次单击“保存”，直接将更改提交到主分支。********
