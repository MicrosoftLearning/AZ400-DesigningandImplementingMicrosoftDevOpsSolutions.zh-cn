...
11. 返回 Boards 窗格，选择窗格顶部的“领域”选项卡 。你会看到此处有一个自动生成的领域，其名称与团队名称一致。
...
9. 在“添加链接”面板的“链接类型”下拉列表中，选择“子级”。   接着，在“工作项类型”下拉列表中选择“功能”，在“标题”文本框中键入“训练仪表板”，然后单击“确定”。    
    ...
    ![包括标题“训练仪表板”，然后单击“确定”](images/m1/EShop-WEB-child_feature_v1.png)

    > **注意**：在“训练仪表板”面板上，请注意，分配、领域和迭代已设置为与该功能所基于的长篇故事相同的值  。 此外，该功能会自动链接到创建时所基于的父项。

10. 在“训练仪表板”面板上，单击“保存并关闭” 。
...
2. 在“冲刺”视图的“任务面板”选项卡上，选择工具栏右侧的“查看选项”符号（漏斗图标左侧），然后在“查看选项”下拉列表中，选择“工作详细信息”条目    。
...
3. 在表示“为最新教程添加页面”的矩形中，单击“未分配”条目，然后在用户帐户列表中，选择你的帐户，将任务分配给自己 。

4. 选择“冲刺”视图的“容量”选项卡 。

    > **注意**：通过此视图，你能够定义用户可进行的活动以及所处的容量级别。

5. 在“冲刺”视图的“容量”选项卡上，在“活动”标签下的“未分配”下拉列表中，选择“开发”，然后在“每天的容量”文本框中键入“1”      。
...
11. 在“冲刺”视图的“任务面板”选项卡上，选择工具栏右侧的“查看选项”符号（漏斗图标左侧），然后在“查看选项”下拉列表中，选择“人员”条目    。
...
2. 在 Boards 面板上，单击“配置团队设置”齿轮图标（位于漏斗图标右侧） 。
...
7. 在“EShop-WEB”面板的“版块”选项卡上，右键单击表示“作为客户，我想查看新教程”积压工作项的“工作项”，然后选择“打开”。   
8. 在“作为客户，我想查看新教程”面板上，在面板顶部的“0 注释”条目右侧，单击“添加标记”  。
9. 在生成的文本框中，键入“数据”并按 Enter 键 。
10. 重复上一步，添加 ux 标记。
11. 在“作为客户，我想查看新教程”面板上，单击“保存并关闭” 。

    ![在“作为客户，我想查看新教程”面板上，单击“保存并关闭”](images/m1/EShop-WEB-tags_v1.png)

    > **注意**：这两个标记目前在卡片上是可见的，根据配置，其中以黄色突出显示了“数据”标记。

12. 在 Boards 面板上，单击“配置团队设置”齿轮图标（位于漏斗图标右侧） 。
...
15. 在“设置”面板的“列”选项卡上，在“已提交”和“完成”之间拖放新创建的选项卡   。
16. 在“设置”面板上，单击“保存并关闭” 。

    ![在“设置”面板上，单击“保存并关闭”。](images/m1/EShop-WEB-qa_column_v1.png)

    > **注意**：验证现在是否可在工作流中看到该新阶段。

17. 刷新 Boards 门户，使“QA 已批准”4 列现在在看板视图中可见。  
...
21. 在 Boards 面板上，单击“配置团队设置”齿轮图标（位于漏斗图标右侧） 。
...
26. 在 Boards 面板上，单击“配置团队设置”齿轮图标（位于漏斗图标右侧） 。
...
29. 在“设置”面板上，单击“保存并关闭” 。

    ![在“设置”面板上查看信息，并单击“保存并关闭”](images/m1/EShop-WEB-swimlane_v1.png)

30. 返回到 Boards 面板的“版块”选项卡，将“已提交”工作项拖放到加速泳道的“已批准 QA \| 执行”阶段，以便在 QA 带宽可用时被识别为优先项    。

    > 注意：如果你想查看包含更多工作项的更精细的版块，请在“版块”面板的“版块”选项卡上，选择左上角的“EShop-WEB”，然后在团队下拉列表中选择“eShopOnWeb 团队”。     此板为你提供一个可进行试验并查看结果的操场。
...
21. 验证目前 PartsUnlimited 组下是否有“票证 ID”字段，该字段在流程自定义期间定义 。 可以将此视为任何其他文本字段。

    ![验证目前 PartsUnlimited 组下是否有“票证 ID”字段，该字段在流程自定义期间定义。 可以将此视为任何其他文本字段。](images/m1/EShop-WEB-verify_v1.png)
...
17. 选择“图表”选项卡，并单击“+ 新建图表” 。
18. 在“配置图表”面板上的“名称”文本框中，键入“Web 任务 - 按分配”，在“分组依据”下拉列表中选择“分配到”，然后单击“确定”以保存更改     。
