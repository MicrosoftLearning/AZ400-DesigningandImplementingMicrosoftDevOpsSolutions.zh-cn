...
1. 我们会将 Wiki 源文件存储在 Repos 当前文件夹结构中一个单独的文件夹中。 在“Repos”中，选择“文件”。 请注意文件夹结构顶部的 EShopOnWeb 存储库标题。 选择省略号（3 个点）****，选择“新建/文件夹”****，并提供“文档”**** 作为“新建文件夹”名称的标题。 由于存储库中不允许创建空文件夹，请提供“READ.ME”作为新文件名。 
1. 按“创建”按钮确认创建文件夹和文件。
